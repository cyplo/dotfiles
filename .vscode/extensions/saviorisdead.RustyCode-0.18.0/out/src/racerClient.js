...
var tmp = require('tmp');
var RacerClient = (function () {
    function RacerClient(config) {
        this.typemap = {
    ...
    RacerClient.prototype.start = function () {
        var _this = this;
    ...
    RacerClient.prototype.stopDaemon = function () {
        this.racerDaemon.kill();
        this.providers.forEach(function (disposable) { return disposable.dispose(); });
        this.providers = [];
    };
    RacerClient.prototype.stopListeners = function () {
        this.listeners.forEach(function (disposable) { return disposable.dispose(); });
        this.listeners = [];
    };
    RacerClient.prototype.stop = function () {
        this.stopDaemon();
        this.stopListeners();
    };
    RacerClient.prototype.restart = function () {
        this.stop();
        this.start();
    };
    RacerClient.prototype.updateTmpFile = function (document) {
        fs.writeFileSync(this.tmpFile, document.getText());
    };
    RacerClient.prototype.definitionProvider = function (document, position, token) {
    ...
    RacerClient.prototype.completionProvider = function (document, position, token) {
        var _this = this;
        this.updateTmpFile(document);
    ...
    RacerClient.prototype.parseParameters = function (line, startingPosition, stopPosition) {
        if (!stopPosition)
    ...
    RacerClient.prototype.parseCall = function (name, line, definition, position) {
    ...
    RacerClient.prototype.firstDanglingParen = function (line, position) {
        var currentDepth = 0;
    ...
    RacerClient.prototype.signatureHelpProvider = function (document, position, token) {
        var _this = this;
        this.updateTmpFile(document);
    ...
    RacerClient.prototype.hookCapabilities = function () {
    ...
    RacerClient.prototype.dataHandler = function (data) {
    ...
    RacerClient.prototype.runCommand = function (command) {
        var _this = this;
...
exports.RacerClient = RacerClient;
